      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Your personal space for mindful reflection. Write about your day,
            your feelings, and receive gentle AI-guided insights to support your
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Card className="text-center p-6 border-border/50 shadow-gentle bg-card/50 backdrop-blur-sm hover:shadow-soft-glow transition-all duration-300 animate-fade-in">
            <CardContent className="pt-4">
              ...
              <p className="text-muted-foreground text-sm">
                Express your thoughts and feelings in a safe, judgment-free
                space
              </p>
            </CardContent>
          </Card>
          ...
          <Card
            className="text-center p-6 border-border/50 shadow-gentle bg-card/50 backdrop-blur-sm hover:shadow-soft-glow transition-all duration-300 animate-fade-in"
